...
export const networks = {
  testnet: {
    ...
    contractId: "CC5P3K3WRFYAENU24OFTQYSJKZGZZOMOIEEXE2UOXP54Y3SG7TVUDMF7",
  }
} as const

export type DataKey = {tag: "Admin", values: void} | {tag: "PendingAdmin", values: void} | {tag: "Underlying", values: void} | {tag: "YieldSource", values: void} | {tag: "TotalShares", values: void} | {tag: "Paused", values: void};
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAFcGF1c2UAAAAAAAAAAAAAAQAAA+kAAAPtAAAAAAAAB9AAAAAOTm92YWlyZVN5RXJyb3IAAA==",
        ...
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABgAAAAAAAAAAAAAABUFkbWluAAAAAAAAAAAAAAAAAAAMUGVuZGluZ0FkbWluAAAAAAAAAAAAAAAKVW5kZXJseWluZwAAAAAAAAAAAAAAAAALWWllbGRTb3VyY2UAAAAAAAAAAAAAAAALVG90YWxTaGFyZXMAAAAAAAAAAAAAAAAGUGF1c2VkAAA=",
        ...
        "",
